...
class PerformanceComp(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials):
        ...
        out_names = ['V_climb_hor', 'P_req_total_hover', 'P_req_total_climb', 'P_req_total_cruise']
        ...
        def fun(x):
            ...
            return jnp.array([V_climb_hor, P_req_total_hover, P_req_total_climb, P_req_total_cruise])
